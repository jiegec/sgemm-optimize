...
static void do_block_small(int K, int lda, float *restrict A, int ldb, float *restrict B, int ldc, float *restrict C)
{
  ...
  for (int k = 0; k < K; ++k)
  {
    ...
    C00 = vmlaq_f32(C00, vld1q_dup_f32(A + 0 + k * lda), b0);
    C04 = vmlaq_f32(C04, vld1q_dup_f32(A + 0 + k * lda), b4);
    C10 = vmlaq_f32(C10, vld1q_dup_f32(A + 1 + k * lda), b0);
    C14 = vmlaq_f32(C14, vld1q_dup_f32(A + 1 + k * lda), b4);
    C20 = vmlaq_f32(C20, vld1q_dup_f32(A + 2 + k * lda), b0);
    C24 = vmlaq_f32(C24, vld1q_dup_f32(A + 2 + k * lda), b4);
    C30 = vmlaq_f32(C30, vld1q_dup_f32(A + 3 + k * lda), b0);
    C34 = vmlaq_f32(C34, vld1q_dup_f32(A + 3 + k * lda), b4);
    C40 = vmlaq_f32(C40, vld1q_dup_f32(A + 4 + k * lda), b0);
    C44 = vmlaq_f32(C44, vld1q_dup_f32(A + 4 + k * lda), b4);
    C50 = vmlaq_f32(C50, vld1q_dup_f32(A + 5 + k * lda), b0);
    C54 = vmlaq_f32(C54, vld1q_dup_f32(A + 5 + k * lda), b4);
    C60 = vmlaq_f32(C60, vld1q_dup_f32(A + 6 + k * lda), b0);
    C64 = vmlaq_f32(C64, vld1q_dup_f32(A + 6 + k * lda), b4);
    C70 = vmlaq_f32(C70, vld1q_dup_f32(A + 7 + k * lda), b0);
    C74 = vmlaq_f32(C74, vld1q_dup_f32(A + 7 + k * lda), b4);
  }
